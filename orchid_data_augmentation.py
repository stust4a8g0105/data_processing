...
if __name__ == '__main__':
    image_path = os.path.join(os.getcwd(), '../Dataset/images/val')
    json_path = os.path.join(os.getcwd(), '../Dataset/label/seperated_labels/val.json')
    image_save_path = os.path.join(os.getcwd(), '../Dataset/images/augmented_val')
    json_save_path = os.path.join(os.getcwd(), '../Dataset/label/augmented_val.json')
