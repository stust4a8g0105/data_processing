...
def main():
    original_image_dir = os.path.join(os.getcwd(), '../Datasets/2688_plus_ChestX_relabling_augmented/images/ChestX_test')
    resized_image_dir = os.path.join(os.getcwd(), '../Datasets/yolov4_2688_plus_ChestX_relabling/images/ChestX_test')
    new_size = (608, 608)
